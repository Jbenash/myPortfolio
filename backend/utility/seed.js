...
const seedData = async () => {
  ...
  try {
    ...
    await Project.create([
      {
        ...
        demoLink:
          "https://www.linkedin.com/posts/ben-asher-78a638275_tech-activity-7398672796815495168-heEy?utm_source=share&utm_medium=member_desktop&rcm=ACoAAEMxBVoBvUXeoxyRk_ulSL1iEvw_Xn3q1Iw", // Placeholder or actual link
        screenshot:
    ...
    await Skills.create([
      ...
      { name: "CSS3", category: "frontend", level: 85, icon: "css3", order: 3 },
      {
        name: "Tailwind CSS",
        category: "frontend",
        level: 75,
